...
export const BUSINESS = {
  ...
  // Titular legal del sitio (LSSI): cuando tengamos nombre completo y NIF,
  // rellenarlos aquí y apareceran automáticamente en el aviso legal.
  legalOwner: {
    name: null, // p. ej. "Nombre Apellidos"
    nif: null, // p. ej. "12345678X"
  },
  googleRating: 5.0,
